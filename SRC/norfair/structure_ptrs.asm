...
StructPtrTable_BANK{BANK}:
    ...
    .word Structure1D_BANK{BANK}
    .word Structure1E_BANK{BANK}
    .word Structure1F_BANK{BANK}
    .word Structure20_BANK{BANK}
    .word Structure21_BANK{BANK}
    .word Structure22_BANK{BANK}
    .word Structure23_BANK{BANK}
    .word Structure24_BANK{BANK}
    .word Structure25_BANK{BANK}
    .word Structure26_BANK{BANK}
    .word Structure27_BANK{BANK}
    .word Structure28_BANK{BANK}
    .word Structure29_BANK{BANK}
    .word Structure2A_BANK{BANK}
    .word Structure2B_BANK{BANK}
    .word Structure2C_BANK{BANK}
    .word Structure2D_BANK{BANK}
    .word Structure2E_BANK{BANK}
    .word Structure2F_BANK{BANK}
    .word Structure30_BANK{BANK}
